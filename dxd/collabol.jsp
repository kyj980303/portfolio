...
<body>
    ...
    <div class="collabomain">
        <p class="maintxt">
            ...
            <span style="font-family: 'HY견고딕';">STUSSY</span>
        </p>
    </div>

    <div class="collabo">
        <h1 style="font-family: 'HY견고딕';">STUSSY</h1>
        <div class="collabotxt">
            ...
            <p>
                <span style="font-family: 'HY견고딕';">다양한 디자인과</span>
                <span style="font-family: 'HY견고딕';">스타일을 겸비한</span>
                <span style="font-family: 'HY견고딕';">브랜드</span>
            </p>
        </div>
    ...
    <div class="collaboshoes">
        ...
        <p style="font-family: 'HY견고딕';">Air Zoom Spiridon Cage2</p>
        <p><a href="#"><span>자세히 보기</span></a></p>
    </div><!--collaboshoes-->

    <div class="nxs">
        <p class="nxsp" style="font-family: 'HY견고딕';">NIKE X STUSSY</p>
        <ul class="collaboshoesprd">
            <li>
                <a href="viewDetailProduct.jsp?prdNo=s1"><img class="cprd" src="../dxd/img/ns1.png"></a>
                <div class="collatxt">
                    <p style="font-family: 'HY견고딕';">에어 허라취 LE</p>
                    <p>280,000원</p>
                    <p>2가지 색상</p>
                </div>
            </li>
            <li>
                ...
                <div class="collatxt">
                    <p style="font-family: 'HY견고딕';">에어 줌 스프리돈 쿠키니</p>
                    <p>209,000원</p>
                    <p>2가지 색상</p>
                </div>
            </li>
            <li>
                ...
                <div class="collatxt">
                    <p style="font-family: 'HY견고딕';">포스1 로우 파슬</p>
                    <p>499,000원</p>
                    <p>2가지 색상</p>
                </div>
            </li>
            <li>
                ...
                <div class="collatxt">
                    <p style="font-family: 'HY견고딕';">에어 허라취 런 울트라</p>
                    <p>139,000원</p>
                    <p>2가지 색상</p>
                </div>
            </li>
