...
<body>
    ...
    <div class="basicShoes">
        ...
        <ul class="shoesPrd">
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s1"><img src="../dxd/img/ss1.png"></a>
                <p>코트 로얄 AC</p>
                <p>78,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s2"><img src="../dxd/img/ss2.png"></a>
                <p>에어맥스 인 버거</p>
                <p>109,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s3"><img src="../dxd/img/ss3.png"></a>
                <p>에어포스1 폰탄카</p>
                <p>149,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s4"><img src="../dxd/img/ss4.png"></a>
                <p>데이브레이크</p>
                <p>119,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s5"><img src="../dxd/img/ss5.png"></a>
                <p>에어조던 5레트로</p>
                <p>229,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s6"><img src="../dxd/img/ss6.png"></a>
                <p>에어맥스 2021</p>
                <p>189,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s7"><img src="../dxd/img/ss7.png"></a>
                <p>로얄 스웨이드</p>
                <p>79,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s8"><img src="../dxd/img/ss8.png"></a>
                <p>조던 자이언1</p>
                <p>109,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s9"><img src="../dxd/img/ss9.png"></a>
                <p>와플 트레이너2</p>
                <p>109,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s10"><img src="../dxd/img/ss10.png"></a>
                <p>나이키 덩크 하이 업</p>
                <p>139,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s11"><img src="../dxd/img/ss11.png"></a>
                <p>에어 허라취 런 울트라</p>
                <p>139,000 원</p>
            </li>
            <li>
                <a href="viewDetailProductl.jsp?prdNo=s12"><img src="../dxd/img/ss12.png"></a>
                <p>레트로 GTS</p>
                <p>79,000 원</p>
            </li>
        </ul>
