...
<body>
    ...
    <div class="bestitem">
        ...
        <ul class="socks3">
            ...
            <li class="bal1">
                <a href="viewDetailSocksl.jsp?prdNo=so1"><img src="img/bestitem1.png" alt="레인보우 발가락 양말"></a>
                <div class="bal1text">
                    <p>레인보우 발가락 양말</p>
                    <p>1500원</p>
                </div>
            ...
            <li class="bal1">
                <a href="viewDetailSocksl.jsp?prdNo=so2"><img src="img/bestitem2.png" alt="컬러 수면 양말"></a>
                <div class="bal1text">
                    <p>컬러 수면 양말</p>
                    <p>1500원</p>
                </div>
