...
<center>
<div class="wis" style ="margin-top:200px; font-size:30px">
        <p>위시리스트</p>
    </div>

  
<div class="wishlist" style="margin-bottom:100px; margin-top:50px;">
<%
try {
...
%> 
        <ul class="wish" style="margin-bottom:-100px">
            <li>
