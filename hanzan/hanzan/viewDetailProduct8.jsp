...
<%@taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt"%>
    ...
    <div class ="gdetail">
        <p class="gp">매일 만나는 하루한잔</p>
        <div class="gbox1"><img src="./img/every.png"></div>
        <div class="gbox2">
            <p>이달에 어울리는 <span>티 한 가지</span></p>
            ...
            <p>매월<span class="pr">16,000원</span></p>
        </div>
    </div>
    <div class="compose">
        <img src="./img/detailG1.png">
    </div> 
	<div class="delicious">
