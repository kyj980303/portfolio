...
%>
		<p style="margin-top:250px; font-size:20px; height:300px">장바구니가 비었습니다.
<%
	}
	else
	{
...
<%
 ...
 %>
    <tr class="total">
        ...
        <td align=right style="position: relative; left:25px;"><b><fmt:formatNumber value="<%=total%>" type="number"/>원</b></td>
    </tr>
    </tbody>
</table>      
<div class="cartbtn">
	<p>
		<a href="deleteAllCart.jsp">장바구니 비우기</a>
