...
%>
    ...
    <div class="categorybest">
        ...
        <ul class="ctgbest">
            <li>
                <a href="viewDetailProduct.jsp?prdNo=M6"><img src="./img/bestM6.png"></a>
                <p>스윗 베리 루이보스티<span>8,800원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct.jsp?prdNo=M1"><img src="./img/bestM1.png"></a>
                <p>도라지차<span>15,000원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct.jsp?prdNo=M2"><img src="./img/bestM2.png"></a>
                <p>캐모마일<span>15,000원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct.jsp?prdNo=M4"><img src="./img/bestM4.png"></a>
                <p>모로칸민트티<span>15,000원</span></p>
            </li>
        </ul>
    </div>
    <footer>
