...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//  findId 내에서 사용되는 자바스크립트 코드의 시작부
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
function id_search() { 
	...
	if (frm.name.value.length < 1) { // 이름을 입력하지 않은 경우 경고창 띄우는 코드
		alert("이름을 입력해주세요");
		return;
	}

	if (frm.telephone.value.length != 13) {  // 핸드폰 번호 13자리를 다 입력하지 않은 경우 경고창 띄우는 코드
...
function favorit()              //  "위시리스트" 버튼을 클릭시 호출
{
	var frm = document.product;
	frm.action = "favorit.jsp";
	frm.submit();
}
