        ...
        <div class="container">
            <div class="card">
                ...
                <div class="face face2">
                    <div class="content">
                        <p><a href="insertMember.jsp">신규 회원 등록</a> / <a href="selectAllMember.jsp">전체 회원 관리</a></p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="face face2">
                    <div class="content">
                        <p><a href="insertGoods.jsp">신규 상품 등록</a> / <a href="selectAllGoods.jsp">전체 상품 관리</a></p>
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div class="face face2">
                    <div class="content">
                        <p><a href="selectAllorder.jsp">전체 주문 관리</a></p>
                    </div>
                </div>
            </div>
        </div>
