...
%>
		...
		<div class="deletegoods">
			<p>다음과 같이 등록된 상품정보를 <span>정말 삭제하시겠습니까?</span></p>
		</div>
        <table cellpadding="10" class="deletgs">
...
<div class="deletegoodsbtn">
	<p>
		<a href="deleteGoodsResult.jsp?prdNo=<%=no%>" style="font-size:10pt;font-family:맑은 고딕">삭제</a>
		<a href="selectAllGoods.jsp" style="font-size:10pt;font-family:맑은 고딕">취소</a>
	</p>
</div>
<%
    } catch (Exception e) {
