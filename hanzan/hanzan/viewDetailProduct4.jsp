...
%>
    ...
    <div class ="mdetail">
        ...
        <div class="mdetailtxt">
            <p><%=name%> 30개입</p>
            <p>
                <span><%=name%>가 낱개로 하나씩 </span>
                <span>총 30개 개별 포장되어있습니다.</span>
                <span>언제 어디서나 간편하게 꺼내어</span>
                <span>즐겨보세요.</span>
                <span>(지름은 4~5cm정도이고 두께는</span>
				<span>1~1.5cm정도입니다.)</span>
            </p>
        </div>
	</div>
	<div class="delicious">
        <p class="delicioustitle"><%=name%>를<span>더 맛있게 즐기는 방법</span></p>
        <ul class="deliciousimg">
            <li>
                <img src="./img/dfirst.png">
                <p>약과준비</p>
                <p>꽃약과를 준비합니다.</p>
            </li>
            <li>
                ...
                <p>전자레인지</p>
                <p>전자레인지에 10초간 데워줍니다.</p>
            </li>
            <li>
                <img src="./img/dthird.png">
                <p>차와 함께</p>
                <p>따뜻한 차와 달달한 약과를 함께 즐긴다.</p>
            </li>
        </ul>
    </div>
    <div class="size">
        <img src="./img/size<%=no%>.png">
        <p>가로 99* 세로 86* 높이 126의 소프트케이스로 되어있습니다. (단위 mm)</p>
    </div>
    ...
    <div class="categorybest">
        ...
        <ul class="ctgbest">
            <li>
                <a href="viewDetailProduct4.jsp?prdNo=H1"><img src="./img/bestH1.png"></a>
                <p>꽃약과<span>8,000원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct4.jsp?prdNo=H6"><img src="./img/bestH2.png"></a>
                <p>금귤정과<span>16,000원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct4.jsp?prdNo=H5"><img src="./img/bestH3.png"></a>
                <p>찹쌀과줄<span>10,000원</span></p>
            </li>
            <li>
                <a href="viewDetailProduct4.jsp?prdNo=H4"><img src="./img/bestH4.png"></a>
                <p>치즈크림떡<span>15,000원</span></p>
            </li>
        </ul>
    </div>
    <footer>
